...
namespace SV21T1020102.DataLayers
{
    public interface IOrderDAL
    {
        ...
        string searchValue = "");
        /// <summary>
        /// Tim kiem k cos search
        /// </summary>
        /// <param name="CustomerID"></param>
        /// <returns></returns>
        int CountNoSearch(int CustomerID);
        /// <summary>
        ...
        /// <param name="CustomerID"></param>
        /// <returns></returns>
        IList<Order>? GetbyCustomer(int CustomerID, int page=1,int pageSize=0);
        /// <summary>
        /// Bổ sung đơn hàng mới
        /// </summary>
        int Add(Order data);
        /// <summary>
        /// Chức năng lập đơn hàng cho khách hàng
        /// </summary>
        /// <param name="data"></param>
        /// <returns></returns>
        int AddForCustomer(Order data);
        /// <summary>
